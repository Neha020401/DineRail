      ...
      <div className="footer-container">
        <div className="footer-section">
          ...
          <p className="footer-description">
            Your one-stop solution for train ticket reservations and food ordering from station stores and onboard
            services.
          </p>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li>
              <Link href="/pnr-status">PNR Status</Link>
            </li>
            <li>
              <Link href="/train-schedule">Train Schedule</Link>
            </li>
            <li>
              <Link href="/cancellations">Cancellations & Refunds</Link>
            </li>
            <li>
              <Link href="/seat-availability">Seat Availability</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li>
              <Link href="/station-food">Station Food Ordering</Link>
            </li>
            <li>
              <Link href="/onboard-meals">Onboard Meal Options</Link>
            </li>
            <li>
              <Link href="/special-meals">Special Diet Meals</Link>
            </li>
            <li>
              <Link href="/group-catering">Group Catering</Link>
            </li>
            <li>
              <Link href="/food-partners">Restaurant Partners</Link>
            </li>
          </ul>
        </div>
